 ...
 //Note 1: This code does not save the resolution set by the player because every time the game opens, it saves the 
    ...
    public class OptionsMenu : MonoBehaviour
    {
        ...
        public void LoadOptionsSettings()
        {
            ...
            Dropdown_Qualities.SetValueWithoutNotify(qualityIndex);
        ...
        void SetQuality(int index)
        {
            ...
            //Debug.Log(" Set quality to index:" + index + ". Previously: " + QualitySettings.GetQualityLevel());
            qualityIndex = index;
            QualitySettings.SetQualityLevel(index);
            //Debug.Log(" New quality level: " + QualitySettings.GetQualityLevel());
        ...
        void LoadResolution()
        {
            ...
            if (saved_w != 0 && saved_h != 0)
            {
                ...
                for (int i = 0; i < supportedResolutions.Count; i++)
                {
                    ...
                    {
                        Dropdown_Resolutions.SetValueWithoutNotify(i);
            ...
            Dropdown_Resolutions.SetValueWithoutNotify(supportedResolutions.Count - 1);
        ...
        void LoadAudio()
        {
            ...
            MuteToggle.SetIsOnWithoutNotify(isMute);
